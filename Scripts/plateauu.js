    ...
    plateau.forEach(function (array) {
        ...
        array.forEach(function (items) {
            if (items !== 99) {
                ...
                {// angle en bas gauche 
                    cell.style.backgroundImage='url("../style/chemin_droit1.jpg")';
                    
                }
                else if (items==47 || items==17)
                {// angle en bas gauche 
                    cell.style.backgroundImage='url("../style/chemin_gh.jpg")';
                    
                }
                else if (items==29 || items==57)
                {// angle en haut droit
                    cell.style.backgroundImage='url("../style/chemin_dh.jpg")';
                    
                }
                else if (items==59 || items==33)
                {// angle en bas droit 
                    cell.style.backgroundImage='url("../style/chemin_db.jpg")';
                    
                }
                else if (tab_v.includes(items) )
                {
                    cell.style.backgroundImage='url("../style/chemin_vertical.jpg")';
                    
                }
                else{
                    cell.style.backgroundImage='url("../style/chemin_droit.jpg")';
